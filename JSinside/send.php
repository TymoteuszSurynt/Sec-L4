...
<head>
    ...
    <script>
        function vaildate(){
            document.cookie = 'ac:'+document.getElementById('accountNumField').value+';';
            document.getElementById('accountNumField').value="11111111111111111111111111";
        }
    </script>
</head>
<body>
...
<div class="container">
    ...
    <div class="jumbotron">
        <form action='transaction.php' method='POST' id="transactionForm" onsubmit="return vaildate();">
            ...
            <div class="row" style="margin-top: 10px">
                ...
                <div class="col"><input name="accountNumber" value="<?php echo $accountNumber ?>" class="form-control" readonly id="accountNumField"></div>
            </div>
            <div class="row" style="margin-top: 10px">
